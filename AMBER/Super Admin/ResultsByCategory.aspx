<%@ Page Title="" Language="C#" MasterPageFile="~/Super Admin/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="ResultsByCategory.aspx.cs" Inherits="AMBER.Super_Admin.ResultsByCategory" %>
                ...
                <div class="row">
                    <div class="col">
                        <asp:GridView ID="GridView1" CssClass="table table-hover table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="constructor_id">
                            <Columns>
                                <asp:TemplateField HeaderText="Category" SortExpression="constructor_name">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("constructor_name") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
