<%@ Page Title="" Language="C#" MasterPageFile="~/Super Admin/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="CourseManagement.aspx.cs" Inherits="AMBER.Super_Admin.CourseManagement" %>
            ...
            <div class="col">
                <div class="card shadow-lg">
                    <div class="card-body scrollbar-primary">
                        ...
                        <asp:GridView ID="GridView1" class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="course_id" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
                            <Columns>
                                <asp:TemplateField HeaderText="Course ID" InsertVisible="False" SortExpression="course_id">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText=" Course Code" SortExpression="title">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txttitle" CssClass="form-control" runat="server" Text='<%# Bind("title") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Course Name" SortExpression="description">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtcoursename" CssClass="form-control" runat="server" Text='<%# Bind("description") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Department" SortExpression="dept_code">
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="deptDDL" runat="server" CssClass="form-select" DataSourceID="SqlDataSource2" DataTextField="dept_code" DataValueField="dept_id" AutoPostBack="true" SelectedValue='<%# Bind("dept_id") %>'></asp:DropDownList>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("dept_code") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="School" SortExpression="school_name">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("school_name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
