<%@ Page Title="" Language="C#" MasterPageFile="~/Super Admin/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="StudentManagement.aspx.cs" Inherits="AMBER.Super_Admin.StudentManagement" %>
                        ...
                        <div class="card-body scrollbar-primary">
                            ...
                            <asp:GridView ID="GridView1" class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="ID Number" SortExpression="stud_id">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtidnum" CssClass="form-control" ReadOnly="true" runat="server" Text='<%# Bind("stud_id") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("stud_id") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Section" SortExpression="section_name">
                                        <EditItemTemplate>
                                            <asp:DropDownList ID="ddlsection" runat="server" CssClass="form-select" DataSourceID="SqlDataSource2" DataTextField="section_name" DataValueField="section_id" AutoPostBack="true" SelectedValue='<%# Bind("section_id") %>'>
                                            </asp:DropDownList>
                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString='<%$ ConnectionStrings:amberDB %>' SelectCommand="SELECT DISTINCT [section_id],[section_name] FROM [SECTION_TABLE]"></asp:SqlDataSource>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label11" runat="server" Text='<%# Bind("section_name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
