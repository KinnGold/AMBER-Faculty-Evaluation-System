<%@ Page Title="" Language="C#" MasterPageFile="~/Super Admin/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="AdminManagement.aspx.cs" Inherits="AMBER.Super_Admin.AdminManagement" %>
                    ...
                    <div class="card-body">
                        <center>
                            <h1 style="color: darkslategray">
                                <i class="fa-solid fa-users-gear"></i>Admin Management</h1>
                        </center>
                    </div>
                </div>
            </div>
                ...
                <div class="col">
                    <div class="card shadow-lg">
                        <div class="card-body scrollbar-primary">
                            ...
                            <asp:GridView ID="GridView1" class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" HeaderStyle-Width="200px">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Contact #" SortExpression="contact_no">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtcnum" CssClass="form-control" runat="server" Text='<%# Bind("contact_no") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label6" runat="server" Text='<%# Bind("contact_no") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Job Position" SortExpression="position">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtjob" CssClass="form-control" runat="server" Text='<%# Bind("position") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label8" runat="server" Text='<%# Bind("position") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="System Role" SortExpression="role">
                                        <EditItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Password" SortExpression="password">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="Label10" runat="server" Text="encrypted"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Username" SortExpression="username">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtusername" ReadOnly="true" CssClass="form-control" runat="server" Text='<%# Bind("username") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label11" runat="server" Text='<%# Bind("username") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Date Signed Up" SortExpression="datesignedup">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtdatesignedup" ReadOnly="true" CssClass="form-control" runat="server" Text='<%# Bind("datesignedup") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label15" runat="server" Text='<%# Bind("datesignedup") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Verfication Code" SortExpression="verify_code">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtverifycode" ReadOnly="true" CssClass="form-control" runat="server" Text='<%# Bind("verify_code") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label12" runat="server" Text='<%# Bind("verify_code") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Forgot Password OTP" SortExpression="forgot_otp">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtforgototp" ReadOnly="true" CssClass="form-control" runat="server" Text='<%# Bind("forgot_otp") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Locked DateTime" SortExpression="lockdatetime">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtlockdatetime" CssClass="form-control" ReadOnly="true" runat="server" Text='<%# Bind("lockdatetime") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label14" runat="server" Text='<%# Bind("lockdatetime") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
