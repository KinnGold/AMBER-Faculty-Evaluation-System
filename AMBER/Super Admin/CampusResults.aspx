<%@ Page Title="" Language="C#" MasterPageFile="~/Super Admin/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="CampusResults.aspx.cs" Inherits="AMBER.Super_Admin.CampusResults" %>
            ...
            <div class="col">
                ...
                <asp:UpdatePanel runat="server">
                    ...
                    <ContentTemplate>
                        <div class="row mb-5">
                            <div class="col-6">
                                <asp:DropDownList ID="DropDownSchool" OnSelectedIndexChanged="DropDownSchool_SelectedIndexChanged" runat="server" AutoPostBack="true" CssClass="form-select  shadow"></asp:DropDownList>
                            </div>
                            <div class="col-6">
                                <asp:Button ID="viewOverallSchoolResultbtn" OnClick="viewOverallSchoolResultbtn_Click" CssClass="btn btn-outline-primary" runat="server" Text="View Overall Result By Campus" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
