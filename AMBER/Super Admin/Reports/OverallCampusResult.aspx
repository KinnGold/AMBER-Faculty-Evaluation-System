<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OverallCampusResult.aspx.cs" Inherits="AMBER.Super_Admin.Reports.OverallCampusResult" %>
            ...
            <div class="row">
                <div class="col">
                    <div class="card" style="background-image: url('/Pictures/former.png'); background-size: cover; background-repeat: no-repeat;">
                        <div class="card-body">
                            <center>
                                <h1 style="color: darkslategray"><i class="fa-solid fa-building-columns"></i> OVERALL CAMPUS RESULTS</h1>
                            </center>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <table class="table table-bordered" runat="server" id="tblDetails">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td id="cellSchooName">School Name: <asp:Label ID="lblSchoolName" Font-Bold="true" runat="server" Text="Label"></asp:Label></td>
                            </tr>
                            <tr>
                                <td id="cellSchooAddress"> School Address: <asp:Label ID="lblSchoolAddress" runat="server" Font-Bold="true" Text="Label"></asp:Label></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
