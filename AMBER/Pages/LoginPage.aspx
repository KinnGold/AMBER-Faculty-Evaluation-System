<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="AMBER.Pages.LoginPage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AMBER - Admin Login</title>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-floating">
                                                        <p>
                                                            ...
                                                            <asp:LinkButton ID="resendemail" CssClass="border-0 bg-transparent text-decoration-underline" OnClick="resendemail_Click" runat="server">Re-send</asp:LinkButton>.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <asp:Button ID="sendemail" OnClick="sendemail_Click" CssClass="btn btn-warning" ValidationGroup="RqSendEmail" runat="server" Text="Send" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
