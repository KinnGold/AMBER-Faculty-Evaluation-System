<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerifyAccount.aspx.cs" Inherits="AMBER.Pages.VerifyAccount" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AMBER - Verify Your Account</title>
    ...
    <script>
        ...
        function VerificationSuccess() {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Congratulations '+ name +' you successfully Signed up for AMBER!',
                text: 'Account Verification Successful, Go to Login now!',
            }).then(function () {
