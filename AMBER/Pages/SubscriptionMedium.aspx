<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubscriptionMedium.aspx.cs" Inherits="AMBER.Pages.SubscriptionMedium" %>
    ...
    <form id="form1" runat="server">
         <div class="container-fluid" style="background-image: url(../Pictures/1.png); background-size: cover">
                <div class="row">
                    ...
                    <div class="col align-self-center">
                        <div class="alert alert-dismissible alert-secondary align-content-center p-5" style="background-color: transparent; border: hidden;">
                            <h1 class="font-weight-bolder">Medium Pack Subscription Plan</h1>
                            <div class="row">
                                <div class="col">
                                    <h5>₱<strong class="font-weight-bolder"> 15000.00</strong>/ 6 Months</h5>
                                    <h5><b style="font-size:large;">✔</b> Add another Admin within the same school to manage</h5>
                                    <h5><b style="font-size:large;">✔</b> 7,000 users is the uploading limit</h5>
        ...
        paypal.Buttons({
            ...
            onApprove: function (data, actions) {
                return actions.order.capture().then(function (details) {
                    console.log(details)
                    sessionStorage.setItem("plan", "medium");
                    window.location.replace("/pages/SubscriptionMediumSuccess.aspx");
                });
            },
