<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/AmberMP.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="EvaluationPeerResult.aspx.cs" Inherits="AMBER.Pages.EvaluationPeerResult" %>
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Label runat="server" Text='<%# Bind("dept_name") %>' ID="Label2" Font-Size="Larger" Font-Bold="true" style="text-align: center;"></asp:Label>
                                                ...
                                                <br />
                                                <asp:Label runat="server" Text='<%# Bind("dept_name") %>' ID="Label2" Font-Size="Larger" Font-Bold="true" Style="text-align: center;"></asp:Label>
                                                <asp:GridView ID="GridviewMembers" GridLines="None" CssClass="table table-hover table-bordered" AutoGenerateColumns="false" runat="server" DataKeyNames="evaluatee_id" OnRowCommand="GridviewMembers_RowCommand">
