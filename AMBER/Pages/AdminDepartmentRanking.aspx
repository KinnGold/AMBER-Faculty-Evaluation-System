<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/AmberMP.Master" AutoEventWireup="true" CodeBehind="AdminDepartmentRanking.aspx.cs" Inherits="AMBER.Pages.AdminDepartmentRanking" %>
        ...
        <div class="row mb-3">
            <div class="col">
                <div class="card shadow-lg" style="background-image: url('../../../Pictures/former.png'); background-repeat: no-repeat;">
                    <div class="card-body">
                        <center>
                            <h1 style="color: darkslategray"><i class="fa-solid fa-ranking-star"></i>&nbsp;&nbsp;Department: Rankings of Evaluation</h1>
                        </center>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row scrollbar-primary" style="overflow-y: scroll">
                                <asp:GridView runat="server" ID="gvranks" CssClass="table table-hover text-center" BorderStyle="None" Font-Bold="true" Font-Size="X-Large" PagerStyle-CssClass="pager" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvranks_PageIndexChanging" OnRowDataBound="gvranks_RowDataBound" AutoGenerateColumns="False" DataKeyNames="dept_id">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="dept_code" HeaderText="Name" ItemStyle-VerticalAlign="Middle"></asp:BoundField>
                                        <asp:BoundField DataField="dept_name" HeaderText="Name" ItemStyle-VerticalAlign="Middle"></asp:BoundField>
