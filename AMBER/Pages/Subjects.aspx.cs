...
namespace AMBER.BM
{
    public partial class Subjects : System.Web.UI.Page
    {
        ...
        protected void GVbind()
        {
            ...
            {
                db.Open();
                SqlCommand cmd = new SqlCommand("SELECT * FROM SUBJECT_TABLE JOIN DEPARTMENT_TABLE ON DEPARTMENT_TABLE.dept_Id = SUBJECT_TABLE.dept_id WHERE SUBJECT_TABLE.SCHOOL_ID = @schoolid AND SUBJECT_TABLE.isDeleted IS NULL", db);
