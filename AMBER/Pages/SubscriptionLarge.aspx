<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubscriptionLarge.aspx.cs" Inherits="AMBER.Pages.SubscriptionLarge" %>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid" style="background-image: url(../Pictures/1.png); background-size: cover">
            <div class="row">
                ...
                <div class="col align-self-center">
                    <div class="alert alert-dismissible alert-secondary align-content-center p-5" style="background-color: transparent; border: hidden;">
                        <h1 class="font-weight-bolder">Large Pack Subscription Plan</h1>
                        <div class="row">
                            <div class="col">
                                <h5>₱<strong class="font-weight-bolder"> 20000.00</strong>/ 6 Months</h5>
                                <h5><b style="font-size: large;">✔</b> Add another Admin within the same school to manage</h5>
                                <h5><b style="font-size: large;">✔</b> There is no uploading limit</h5>
