<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Users/UsersMP.Master" AutoEventWireup="true" CodeBehind="SelfEvaluation.aspx.cs" Inherits="AMBER.Pages.Users.Faculty.SelfEvaluation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function toast() {
            Swal.fire({
                icon: 'warning',
                title: 'You already have Evaluated yourself',
                toast: true,
                position: 'top-right',
                iconColor: 'white',
                customClass: {
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div class="container p-4 p-md-5 pt-5">
        <div class="row px-3">
            <div class="card border overflow-auto border-0 shadow">
                <div class="card-body">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered" style="background-color: #ebecf0;">
                        <thead>
                            <tr>
