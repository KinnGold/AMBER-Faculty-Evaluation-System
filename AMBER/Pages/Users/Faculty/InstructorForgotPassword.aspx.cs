...
{
    public partial class InstructorForgotPassword : System.Web.UI.Page
    {
                        ...
                        try
                        {
                            using (var db = new SqlConnection(connDB))
                            {
                                ...
                                using (var cmd = db.CreateCommand())
                                {
                                    ...
                                    cmd.CommandText = "SELECT * FROM INSTRUCTOR_TABLE WHERE forgot_otp='" + AMBER.URLEncryption.GetdecryptedQueryString(forgot_otp) + "'";
            ...
            else
            {
                try
                {
                    using (var db = new SqlConnection(connDB))
                    {
                        ...
                        {
                            cmd.CommandType = CommandType.Text;
                            cmd.CommandText = "UPDATE INSTRUCTOR_TABLE SET password=@pass WHERE forgot_otp='" + forgot_otp + "'";
