<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Users/UsersMP.Master" AutoEventWireup="true" CodeBehind="InstructorProfile.aspx.cs" Inherits="AMBER.BM.Users.Faculty.InstructorProfile" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div class="container-fluid pt-2 pb-2 min-vh-100 m-0 d-flex flex-column justify-content-center bg-transparent" style="background-image: url(/../../Pictures/1.png); background-size: cover; height: 100%; width: 100%;">
        <div class="row">
                                                ...
                                                <div class="col">
                                                        ...
                                                        <div class="col mx-auto">
                                                            <center>
                                                                <div class="profileBG">
                                                                    ...
                                                                    <asp:FileUpload runat="server" oninput="body_profilePic.src=window.URL.createObjectURL(this.files[0])" ID="updateProfile" class="my_profile" xmlns:asp="#unknown" onchange="showButton()" />
                                                                </div>
                                                            </center>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col d-grid mx-auto">
                                                            <center>
                                                                <asp:Button runat="server" Text="Update Profile Photo" class="btn text-warning" Style="width: 250px; display:none;"  xmlns:asp="#unknown" ID="upload" OnClick="upload_Click1" />
                                                            </center>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <asp:Label ID="insrole" runat="server" Text="Role:"></asp:Label>
                                                        </div>
                                                        <div class="col">
                                                            <asp:Label ID="displayinsrole" Font-Bold="true" runat="server"></asp:Label>
                                                        </div>
                                                    </div>

                                                    <div class="row">
                                                        <div class="col">
                                                            <asp:Label ID="insname" runat="server" Text="Name:"></asp:Label>
                                                        </div>
                                                        <div class="col">
                                                            <asp:Label ID="displayinsname" Font-Bold="true" runat="server"></asp:Label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <asp:Label ID="insdept" runat="server" Text="Department:"></asp:Label>
                                                        </div>
                                                        <div class="col">
                                                            <asp:Label ID="displayinsdept" Font-Bold="true" runat="server"></asp:Label>
                                                        </div>
                                                    </div>

                                                    <div class="row">
                                                        <div class="col">
                                                            <asp:Label ID="insschool" runat="server" Text="School:"></asp:Label>
                                                        </div>
                                                        <div class="col">
                                                            <asp:Label ID="displayinsschool" Font-Bold="true" runat="server"></asp:Label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <asp:Button ID="btnrequest" OnClick="btnrequest_Click" CssClass="btn btn-success" ValidationGroup="RqRequest" runat="server" Text="Send" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal fade" id="EditPassModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel1" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                                    <asp:Button ID="savepassbtn" OnClick="savepassbtn_Click" CssClass="btn btn-success" ValidationGroup="RqSavePass" runat="server" Text="Save" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
