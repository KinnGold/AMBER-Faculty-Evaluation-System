<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountVerification.aspx.cs" Inherits="AMBER.Pages.Users.Student.AccountVerification" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AMBER - Verify Account</title>
    ...
    <script>
        ...
        function VerificationSuccess() {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Congratulations ' + name + ' you successfully verfied your AMBER account!',
                text: 'Account Verification Successful, Logging in..',
            }).then(function () {
                window.location = "/Pages/Users/LandingPage.aspx";
            });
        }
    </script>
</head>
                            ...
                            <asp:PlaceHolder ID="plcinput" runat="server">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col mx-auto">
                                            <div class="form-floating mb-3">
                                                <asp:Label ID="insid" runat="server" Text="Verify your account"></asp:Label>
                                            </div>
                                            <div class="form-floating mb-3">
                                    ...
                                    <div class="d-grid gap-2 col-8 mx-auto pb-1">
                                        <asp:Button ID="btnverifynow" OnClick="btnverifynow_Click" class="btn btn-primary" runat="server" ValidationGroup="RqVerify" Text="Verify" />
                                    </div>
                                </div>
                            </asp:PlaceHolder>
                        </div>
