<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Users/UsersMP.Master" AutoEventWireup="true" CodeBehind="SkillsTest.aspx.cs" Inherits="AMBER.Pages.Users.Dean.SkillsTest" %>
    ...
    <div class="container p-4 p-md-5 pt-5">
        <div class="row mb-3 d-flex align-items-center" style="border-radius: 10px; background-color: #ec9706;">
            ...
            <div class="col-3 mx-4">
                <asp:Label runat="server" ID="lblINS" Visible="false" Style="font-weight: 600; color: white; font-size: 25px;"></asp:Label>
