...
{
    public partial class DeanSectionManage : System.Web.UI.Page
    {
            ...
            try
            {
                using (var db = new SqlConnection(connDB))
                {
                    ...
                    using (var cmd = db.CreateCommand())
                    {
                        ...
                        cmd.CommandText = "SELECT course_id,(title+' - '+description) AS COURSE FROM COURSE_TABLE WHERE SCHOOL_ID = '" + Session["school"].ToString() + "' AND isDeleted IS NULL AND dept_id = '" + Session["dept"].ToString() + "'";
