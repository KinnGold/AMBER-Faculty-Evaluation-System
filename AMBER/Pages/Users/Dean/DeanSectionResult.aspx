<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Users/UsersMP.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="DeanSectionResult.aspx.cs" Inherits="AMBER.Pages.Users.Dean.DeanSectionResult" %>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:GridView ID="GridviewSchedule" GridLines="Horizontal" CssClass="table table-hover table-bordered" AutoGenerateColumns="false" runat="server" DataKeyNames="sched_Id" OnRowCommand="GridviewSchedule_RowCommand">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="isEvaluated" HeaderText="Evaluated?" SortExpression="isEvaluated"></asp:BoundField>
