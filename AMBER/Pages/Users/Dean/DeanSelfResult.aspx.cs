...
{
    public partial class DeanSelfResult : System.Web.UI.Page
    {
        ...
        protected void GridviewMembers_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "selectMember")
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, GetType(), "NewTab", "customOpen('https://localhost:44311/Pages/Reports/IndividualSelfResult.aspx?dept_id=" + AMBER.URLEncryption.GetencryptedQueryString(parentKey) + "&id=" + AMBER.URLEncryption.GetencryptedQueryString(childKey) + "');", true);
                //Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "NewTab", "window.open('https://localhost:44311/Pages/Reports/IndividualSelfResult.aspx?dept_id=" + AMBER.URLEncryption.GetencryptedQueryString(parentKey) + "&id=" + AMBER.URLEncryption.GetencryptedQueryString(childKey) + "','_blank');", true);
            }
        }
    }
}