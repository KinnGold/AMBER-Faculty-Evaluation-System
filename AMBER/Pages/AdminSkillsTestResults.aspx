<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/AmberMP.Master" AutoEventWireup="true" CodeBehind="AdminSkillsTestResults.aspx.cs" Inherits="AMBER.Pages.AdminSkillsTestResults" %>
        ...
        <div class="row mb-5">
            <div class="col">
                <div class="card shadow-lg" style="background-image: url('../../Pictures/former.png'); background-size: cover; background-repeat: no-repeat;">
                    <div class="card-body">
                        <center>
                            <h1 style="color: darkslategray"><i class="fa-solid fa-square-check"></i>
                                Skills Test Result</h1>
                        </center>
                    </div>
                </div>
            </div>
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="row">
                                <div class="row">
                                    <div class="col">
                                        <asp:DropDownList ID="ddlDepartment" AutoPostBack="true" CssClass="form-select" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged" runat="server"></asp:DropDownList>
                                    </div>
                                    <div class="col">
                                    </div>
                                </div>
