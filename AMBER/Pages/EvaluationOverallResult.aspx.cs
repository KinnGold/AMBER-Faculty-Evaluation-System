...
{
    public partial class EvaluationOverallResult : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                GVbind("");
                populateDDL();
                viewDepartmentbtn.Visible = false;
            }
        }
        void populateDDL()
        {
        ...
        protected void ddlDepartment_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlDepartment.SelectedValue != "-Department-")
            {
                ...
                viewDepartmentbtn.Visible = true;
            }
            else
            {
                GVbind("");
        ...
        protected void viewDepartmentbtn_Click(object sender, EventArgs e)
        {
            ScriptManager.RegisterClientScriptBlock(this, GetType(), "NewTab", "customOpen('https://localhost:44311/Pages/Reports/DepartmentalResult.aspx?dept_id=" + AMBER.URLEncryption.GetencryptedQueryString(ddlDepartment.SelectedValue)+ "');", true);
        }
    }
}