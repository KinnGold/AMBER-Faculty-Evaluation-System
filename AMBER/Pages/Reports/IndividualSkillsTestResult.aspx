<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndividualSkillsTestResult.aspx.cs" Inherits="AMBER.Pages.Reports.IndividualSkillsTestResult" %>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-8 mx-auto">
                    <asp:Literal ID="ltOverallGraph" runat="server"></asp:Literal>
                </div>
            </div>
            <hr />
            <div class="row">
