<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndividualPeerResult.aspx.cs" Inherits="AMBER.Pages.Reports.IndividualPeerResult" %>
            ...
            <div class="row">
                <div class="col">
                    <div class="card" style="background-image: url('/Pictures/former.png'); background-size: cover; background-repeat: no-repeat;">
                        <div class="card-body">
                            <center>
                                <h1 style="color: darkslategray"><i class="fa-solid fa-briefcase"></i>PEER EVALUATION RESULTS</h1>
                            </center>
                        </div>
                    </div>
                </div>
