<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndividualSelfResult.aspx.cs" Inherits="AMBER.Pages.Reports.IndividualSelfResult" %>
            ...
            <div class="row">
                <div class="col">
                    <div class="card" style="background-image: url('/Pictures/former.png'); background-size: cover; background-repeat: no-repeat;">
                        <div class="card-body">
                            <center>
                                <h1 style="color: darkslategray"><i class="fa-solid fa-image-portrait"></i>SELF EVALUATION RESULTS</h1>
                            </center>
                        </div>
                    </div>
                </div>
