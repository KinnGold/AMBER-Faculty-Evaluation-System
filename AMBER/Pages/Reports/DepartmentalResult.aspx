<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentalResult.aspx.cs" Inherits="AMBER.Pages.Reports.DepartmentalResult" %>
                ...
                <div class="col">
                    <table class="table table-bordered" runat="server" id="tblDetails">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td id="cellDeptName">Department Name: </td>
                            </tr>
                            <tr>
                                <td id="celSubject">Deparment Code: </td>
                            </tr>
                            <tr>
