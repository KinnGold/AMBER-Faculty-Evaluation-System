<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndividualSectionResult.aspx.cs" Inherits="AMBER.Pages.Reports.IndividualResult" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <div class="card" style="background-image: url('/Pictures/former.png'); background-size: cover; background-repeat: no-repeat;">
                        <div class="card-body">
                            <center>
                                <h1 style="color: darkslategray"><i class="fa-solid fa-clipboard-user"></i>STUDENTS EVALUATION RESULTS</h1>
                            </center>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <table class="table table-warning table-bordered" runat="server" id="tblDetails">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td id="celSection">Section Code: </td>
                            </tr>
                            <tr>
                                <td id="celGroupCount">Total of students in this Class: </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
